# -*- coding: utf-8 -*-
"""
Created on Sun Jun  7 19:46:38 2026
...
def hill_climbing(start_x,step_size,max_iterations):
    ...
    print("\nFinal Solution:")
    print(f"X={current_x:.4f},f(x)={current_value:.4f}")
    return current_x,current_value
best_x,best_value=hill_climbing(start_x=0.1,step_size=1.0,max_iterations=6)